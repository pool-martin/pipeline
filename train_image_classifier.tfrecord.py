...
def parser(serialized_example):
  ...
  fragment = [
      tf.image.decode_jpeg(features['image/encoded_0'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_1'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_2'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_3'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_4'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_5'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_6'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_7'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_8'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_9'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_10'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_11'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_12'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_13'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_14'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_15'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_16'], channels=3),
      ...
      tf.image.decode_jpeg(features['image/encoded_24'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_25'],channels=3),
      tf.image.decode_jpeg(features['image/encoded_26'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_27'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_28'], channels=3),
      tf.image.decode_jpeg(features['image/encoded_29'], channels=3) ]
