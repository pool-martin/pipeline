...
#            global dataset_loader
            ...
            snippet = tf.py_func(get_video_frames, [video_path, frames_identificator, snippet_path, image_size, FLAGS.split_type], tf.uint8, stateful=False, name='retrieve_snippet')
