...
def input_fn(videos_in_split,
    ...
    last_fragments_table = tf.contrib.lookup.HashTable(  tf.contrib.lookup.KeyValueTensorInitializer(tf.constant(list(last_fragments.keys())), tf.constant(list(last_fragments.values()))), -1 )
